          ...
          showResponse.sellado && showResponse.data.timestamp ? (
            <div className="text-left grid gap-4 overflow-auto">
              ...
              <div className="grid gap-1 ">
                ...
                <p className="text-sm"><a style="color: cornflowerblue;text-decoration: underline;" href={"https://demo-001-node.cloud.nxtfi.org/v2/_block/" + showResponse.data.hash}>{showResponse.data.hash}</a></p>
              </div>
              {
